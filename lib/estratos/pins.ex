defmodule Estratos.Pins do
  ...
  def get_entity_for_pin(%Pin{entity_type: entity_type, entity_id: id}) do
    type_info = Estratos.EntityTypes.get_type(entity_type)
    Repo.get!(type_info.schema_module, id)
  end
end
